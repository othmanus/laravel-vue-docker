<template>
    <div class="w-full max-w-md px-2 py-2 sm:px-6 sm:py-6">
        <form class="bg-white shadow-md rounded px-2 py-2 sm:px-8 sm:py-6 mb-4" method="POST" action="/login">
            ...
            <div class="flex justify-between items-center">
                <button class="block bg-green-500 hover:bg-green-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline" type="submit">Login</button>
                <a class="block text-sm text-green-500 hover:text-green-800" href="#">Forget password?</a>
            </div>
        </form>
    </div>
</template>
